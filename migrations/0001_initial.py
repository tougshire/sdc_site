# Generated by Django 4.2.4 on 2024-03-07 18:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(blank=True, help_text='The content of the article.  Expected to usually include an iframe or series of iframes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_before_articles', models.CharField(blank=True, help_text='The content of the case before any included articles', max_length=255)),
                ('content_after_articles', models.CharField(blank=True, help_text='The content of the case after any included articles', max_length=255)),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_before_cases', models.TextField(blank=True, help_text='content to be displayed before the cases')),
                ('content_after_cases', models.TextField(blank=True, help_text='content to be displayed after the cases')),
